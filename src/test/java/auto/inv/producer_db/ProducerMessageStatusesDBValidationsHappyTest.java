...
public class ProducerMessageStatusesDBValidationsHappyTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerMessageStatusesDBValidationsHappyTest.class);
    ...
    public void sendKafkaMessageDbValidationsHappyTest() throws ExecutionException, InterruptedException, SQLException, NoSuchFieldException {
        ...
        if (rs.next()) {
            ...
            if (guidDB.equals(GUIDProducer)) {
                ...
                assertThat(adminSystemDB).isEqualTo(eventBodyRecord.get("AdminSystem"));
                assertThat(primaryHoldingKeyDB).isEqualTo(eventBodyRecord.get("Primary_H_Id1"));
