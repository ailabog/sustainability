...
public class ProducerAvroSchemaDummyDataConsumerValidationsTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerAvroSchemaDummyDataConsumerValidationsTest.class);
    ...
    @Test
    public void produceMessageConsumerValidationsDummyDataTest() throws ExecutionException, InterruptedException {
        ...
        for (ConsumerRecord<String, GenericRecord> record : records) {
            ...
            assertNotEquals(eventCorrelationId, eventCorrelationIdConsumer);
        }
        consumer.close();
    }
}
