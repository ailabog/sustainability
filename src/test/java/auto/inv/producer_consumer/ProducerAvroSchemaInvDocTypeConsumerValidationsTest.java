...
public class ProducerAvroSchemaInvDocTypeConsumerValidationsTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerAvroSchemaInvDocTypeConsumerValidationsTest.class);
    Date now = new Date();
    ...
    @Test
    public void producerMessageInvDocTypeConsumerValidationsTest() throws ExecutionException, InterruptedException {
