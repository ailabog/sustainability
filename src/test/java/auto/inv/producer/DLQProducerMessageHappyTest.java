...
public class DLQProducerMessageHappyTest {
    protected static final Logger logger = LoggerFactory.getLogger(DLQProducerMessageHappyTest.class);
    ...
    @Test
    public void sendDlqMessageHappyTest() throws ExecutionException, InterruptedException {
