...
public class ProducerAvroSchemaDummyDataTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerAvroSchemaDummyDataTest.class);
    ...
    @Test
    public void sendKafkaMessageTest() throws ExecutionException, InterruptedException {
