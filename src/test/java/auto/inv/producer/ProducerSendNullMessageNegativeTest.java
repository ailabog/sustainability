...
public class ProducerSendNullMessageNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerSendNullMessageNegativeTest.class);
    @Test
    public void sendKafkaNullMessageTest() {
        ...
        ProducerRecord<Object, Object> record = new ProducerRecord<>(ConfigUtils.getProperty(String.valueOf(ConfigUtils.ConfigKeys.TOPIC_NAME_PRODUCER)), null, null);
        ...
        logger.info("A new poison pill, null message was sent on topic:" + ConfigUtils.getProperty(String.valueOf(ConfigUtils.ConfigKeys.TOPIC_NAME_PRODUCER)));
    }
}
