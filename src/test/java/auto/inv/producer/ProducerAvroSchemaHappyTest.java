...
public class ProducerAvroSchemaHappyTest {
    ...
    @Test
    public void produceComposeAgreementKeyMessageHappyTest() throws ExecutionException, InterruptedException {
        KafkaProducerSetup kafkaProducerSetup = new KafkaProducerSetup();
