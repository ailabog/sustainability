...
public class DLQProducerSendDummyDataTest {
    protected static final Logger logger = LoggerFactory.getLogger(DLQProducerSendDummyDataTest.class);
    ...
    @Test
    public void sendDlqDummyDataNegativeTest() throws ExecutionException, InterruptedException {
