...
public class ProducerAvroSchemaInvDocTypeNegativeTest {
    protected static final Logger logger = LoggerFactory.getLogger(ProducerAvroSchemaInvDocTypeNegativeTest.class);
    ...
    String adminSystem = "LOL";
    String docClass = "";
    String GUID = '{' + generateUUID.toString() + '}';

    @Test
    public void sendKafkaMessageInvDocTypeTest() throws ExecutionException, InterruptedException {
